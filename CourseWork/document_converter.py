...
# constants
notebook_path = '/home/choleraplague/university/DataAnalysis/DataAnalysisFourthSemester/CourseWork/'
notebook_name = 'work'
out_name = 'КР_ІП11_Панченко.docx'
...
new_heading_one_style_name = 'Heading 2'# add_heading_one_style(document)
new_heading_two_style_name = 'Heading 3' #add_heading_two_style(document)
